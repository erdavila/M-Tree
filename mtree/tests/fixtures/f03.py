...
ACTIONS = (
	...
	REMOVE((50, 18, 85, 45), QUERY((27, 65, 93, 13), 64.11474980906463, 5)),
	REMOVE((76, 37, 59, 92), QUERY((60, 4, 33, 59), 42.945752330314434, 0)),
	ADD((70, 4, 97, 67), QUERY((85, 99, 62, 47), 17.638848416562205, 5)),
	ADD((73, 71, 83, 34), QUERY((77, 92, 94, 84), 36.61127295233709, 3)),
	ADD((68, 95, 14, 64), QUERY((2, 6, 91, 87), 55.49188671780003, 3)),
	REMOVE((70, 4, 97, 67), QUERY((21, 10, 23, 86), 45.80958512596745, 7)),
	REMOVE((68, 95, 14, 64), QUERY((46, 83, 34, 29), 1.790981022255398, 2)),
	REMOVE((73, 71, 83, 34), QUERY((47, 82, 60, 46), 77.12167724151024, 4)),
)
